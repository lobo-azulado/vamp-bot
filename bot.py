...
if __name__ == "__main__":
    ...
    if not token:
        ...
        print("💡 Certifique-se de definir a variável DISCORD_TOKEN")
        print("   - No arquivo .env: DISCORD_TOKEN=seu_token_aqui")
        print("   - Na hospedagem: Configure a variável de ambiente")
        exit(1)
